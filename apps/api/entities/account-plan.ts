import { AccountPlan, FieldKind, FieldState, PlanField } from '@prici/shared-remult';
import { EntityOptions, remult } from 'remult';
import { defaultTenant } from '../config';


export function applyOptionsForAccountPlan(options: EntityOptions<AccountPlan>) {
